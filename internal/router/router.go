...
func Create() *mux.Router {
	...
	api.Methods("GET").Path("/questions/{id:[0-9]+}").Handler(helper.Middlewares(http.HandlerFunc(qHr.SeeQuestion), mw.Authenticated))
	...
	api.PathPrefix("/").HandlerFunc(handler.ApiNotFound)
